...
JiwakaHomeWidget::JiwakaHomeWidget(QWidget *parent) : QWidget(parent)
{
    ...
    // new syntax
    connect(button_kiwi, &QPushButton::clicked, this, &JiwakaHomeWidget::onKiwiClicked);


    setObjectName("JiwakaHomewidget");
    setStyleSheet("#JiwakaHomewidget QPushButton{background-color:black;padding:6px;border-radius:20px;} QPushButton::hover{background-color:#0047AB;} QPushButton::pressed{background-color:#424242;}");


}

void JiwakaHomeWidget::onKiwiClicked()
{
